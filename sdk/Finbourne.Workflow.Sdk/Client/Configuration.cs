...
namespace Finbourne.Workflow.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.1.835";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.1.835/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.1.835\n";
            report += "    SDK Package Version: 0.1.835\n";
