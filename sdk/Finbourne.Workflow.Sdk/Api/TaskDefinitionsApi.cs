...
namespace Finbourne.Workflow.Sdk.Api
{
    ...
    public interface ITaskDefinitionsApiSync : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfTaskDefinition> ListTaskDefinitionsWithHttpInfo(string scope);
        /// <summary>
    ...
    public interface ITaskDefinitionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ResourceListOfTaskDefinition> ListTaskDefinitionsAsync(string scope, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfTaskDefinition>> ListTaskDefinitionsWithHttpInfoAsync(string scope, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] ListTasksForTaskDefinition: List Tasks for a Task Definition
        /// </summary>
        /// <remarks>
    ...
    public partial class TaskDefinitionsApi : ITaskDefinitionsApi
    {
        ...
        /// <param name="scope"></param>
        /// <returns>ResourceListOfTaskDefinition</returns>
        public ResourceListOfTaskDefinition ListTaskDefinitions(string scope)
        {
            Finbourne.Workflow.Sdk.Client.ApiResponse<ResourceListOfTaskDefinition> localVarResponse = ListTaskDefinitionsWithHttpInfo(scope);
            return localVarResponse.Data;
        }
        ...
        /// <param name="scope"></param>
        /// <returns>ApiResponse of ResourceListOfTaskDefinition</returns>
        public Finbourne.Workflow.Sdk.Client.ApiResponse<ResourceListOfTaskDefinition> ListTaskDefinitionsWithHttpInfo(string scope)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfTaskDefinition</returns>
        public async System.Threading.Tasks.Task<ResourceListOfTaskDefinition> ListTaskDefinitionsAsync(string scope, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Workflow.Sdk.Client.ApiResponse<ResourceListOfTaskDefinition> localVarResponse = await ListTaskDefinitionsWithHttpInfoAsync(scope, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfTaskDefinition)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Workflow.Sdk.Client.ApiResponse<ResourceListOfTaskDefinition>> ListTaskDefinitionsWithHttpInfoAsync(string scope, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Finbourne.Workflow.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling TaskDefinitionsApi->ListTaskDefinitions");
