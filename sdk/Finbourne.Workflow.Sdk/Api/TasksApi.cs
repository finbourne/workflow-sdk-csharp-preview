...
namespace Finbourne.Workflow.Sdk.Api
{
    ...
    public partial class TasksApi : ITasksApi
    {
        ...
        public Finbourne.Workflow.Sdk.Client.ApiResponse<Task> CreateTaskWithHttpInfo(CreateTaskRequest createTaskRequest, string trigger = default(string))
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "0.1.242");
        ...
        public Finbourne.Workflow.Sdk.Client.ApiResponse<Task> UpdateTaskWithHttpInfo(string id, string trigger = default(string), UpdateTaskRequest updateTaskRequest = default(UpdateTaskRequest))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Task>("/api/tasks/{id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Finbourne.Workflow.Sdk.Client.ApiResponse<Task>> UpdateTaskWithHttpInfoAsync(string id, string trigger = default(string), UpdateTaskRequest updateTaskRequest = default(UpdateTaskRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Task>("/api/tasks/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
