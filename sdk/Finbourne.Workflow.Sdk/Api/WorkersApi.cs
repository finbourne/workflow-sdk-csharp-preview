...
namespace Finbourne.Workflow.Sdk.Api
{
    ...
    public interface IWorkersApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfWorker ListWorkers(DateTimeOffset? asAt = default(DateTimeOffset?), string? filter = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? page = default(string?));
        ...
        ApiResponse<PagedResourceListOfWorker> ListWorkersWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string? filter = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? page = default(string?));
        /// <summary>
    ...
    public partial class WorkersApi : IDisposable, IWorkersApi
    {
        ...
        /// <param name="page">The pagination token to use to continue listing workers from a previous call to list workers. This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields must not have changed since the original request. (optional)</param>
        /// <returns>PagedResourceListOfWorker</returns>
        public PagedResourceListOfWorker ListWorkers(DateTimeOffset? asAt = default(DateTimeOffset?), string? filter = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? page = default(string?))
        {
        ...
        /// <param name="page">The pagination token to use to continue listing workers from a previous call to list workers. This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields must not have changed since the original request. (optional)</param>
        /// <returns>ApiResponse of PagedResourceListOfWorker</returns>
        public Finbourne.Workflow.Sdk.Client.ApiResponse<PagedResourceListOfWorker> ListWorkersWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string? filter = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? page = default(string?))
        {
            Finbourne.Workflow.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Workflow.Sdk.Client.RequestOptions();
        ...
        {
            Finbourne.Workflow.Sdk.Client.ApiResponse<PagedResourceListOfWorker> localVarResponse = await ListWorkersWithHttpInfoAsync(asAt, filter, sortBy, limit, page, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
