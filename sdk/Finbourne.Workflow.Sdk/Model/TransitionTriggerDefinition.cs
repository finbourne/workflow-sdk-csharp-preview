...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class TransitionTriggerDefinition : IEquatable<TransitionTriggerDefinition>
    {
        ...
        public TransitionTriggerDefinition(string name = default(string), TriggerSchema trigger = default(TriggerSchema))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for TransitionTriggerDefinition and cannot be null");
            // to ensure "trigger" is required (not null)
            this.Trigger = trigger ?? throw new ArgumentNullException("trigger is a required property for TransitionTriggerDefinition and cannot be null");
        }
