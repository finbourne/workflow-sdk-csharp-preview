...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class TaskInstance : IEquatable<TaskInstance>
    {
        ...
        public TaskInstance(TaskDefinitionId taskDefinitionId = default(TaskDefinitionId), Guid taskInstanceId = default(Guid), string correlationId = default(string), List<State> states = default(List<State>), List<Transition> transitions = default(List<Transition>), List<Trigger> triggers = default(List<Trigger>), string activeState = default(string), Status? status = default(Status?), bool terminalState = default(bool), DateTimeOffset created = default(DateTimeOffset), string updated = default(string), string lastTransition = default(string), List<FieldInstance> fields = default(List<FieldInstance>), List<string> receivers = default(List<string>), List<HistoryEntry> history = default(List<HistoryEntry>))
        {
