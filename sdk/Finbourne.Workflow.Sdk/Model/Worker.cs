...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class Worker : IEquatable<Worker>
    {
        ...
        public Worker(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), WorkerConfiguration workerConfiguration = default(WorkerConfiguration), Version version = default(Version), List<Parameter> parameters = default(List<Parameter>), List<Link> links = default(List<Link>))
        {
