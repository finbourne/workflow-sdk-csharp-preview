...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class UpdateTaskResponse : IEquatable<UpdateTaskResponse>
    {
        /// <summary>
        ...
        public UpdateTaskResponse(bool wasSuccessful = default(bool), DateTimeOffset? asAt = default(DateTimeOffset?), string message = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateTaskResponse);
        }

        /// <summary>
        /// Returns true if UpdateTaskResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTaskResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTaskResponse input)
        {
            if (input == null)
                return false;
